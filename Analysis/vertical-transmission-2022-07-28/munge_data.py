...
reps = range(10,20)
header = "vert,rep,update,partner,donated,earned,task_NOT,task_NAND,task_AND,task_ORN,task_OR,task_ANDN,task_NOR,task_XOR,task_EQU"
    ...
    for r in reps:
            ...
            for line in curFile:
                if (line[0] != "u"):
                    ...
                    outstring2 = f"{outstring1},symbiont,{dLine[2].strip()},{dLine[1].strip()}"
                    outstring1 += ",host,0,0"
