...
for a in seeds:
    for hres in horiz_res:
        for vres in vert_res:
            ...
            for b in verts:
                ...
                command_str = f'./symbulation_sgp -SEED {a} -VERTICAL_TRANSMISSION {b} -SYM_HORIZ_TRANS_RES {hres} -SYM_VERT_TRANS_RES {vres} -FILE_NAME _VT_{b}_HR_{hres}_VR_{vres}'
                settings_filename = f"Output_VT_{b}_HR_{hres}_VR_{vres}_SEED{a}.data"
